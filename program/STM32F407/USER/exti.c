...
void exti_init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOE, ENABLE);//使能GPIOA,GPIOB,GPIOE时钟
  ...
  GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化GPIOE2
	...
	EXTI_InitStructure.EXTI_Line =  EXTI_Line4 | EXTI_Line12 | EXTI_Line2;
